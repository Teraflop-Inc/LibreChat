...
export const greetingSlotsByDay: Partial<Record<DayKey, GreetingSlot[]>> = {
  sun: [
    { until: 5, key: 'com_ui_greeting_think_through' },
    ...
    { until: 24, key: 'com_ui_greeting_think_through' },
  ],
  ...
  mon: [
    ...
    { until: 22, key: 'com_ui_greeting_evening_shift' },
    { until: 24, key: 'com_ui_greeting_think_through' },
  ],

  wed: [
    { until: 5, key: 'com_ui_greeting_think_through' },
    { until: 12, key: 'com_ui_greeting_early_bird' },
    { until: 17, key: 'com_ui_greeting_working_on' },
    { until: 22, key: 'com_ui_greeting_returns', namedKey: 'com_ui_greeting_returns_named' },
    { until: 24, key: 'com_ui_greeting_think_through' },
  ],
  ...
  sat: [
    { until: 5, key: 'com_ui_greeting_up_late', namedKey: 'com_ui_greeting_up_late_named' },
    { until: 12, key: 'com_ui_greeting_coffee' },
    { until: 17, key: 'com_ui_greeting_tackle' },
    {
      until: 22,
      key: 'com_ui_greeting_winding_down',
      namedKey: 'com_ui_greeting_winding_down_named',
